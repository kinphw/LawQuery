# 250702 v0.1.0
# MySQL 데이터베이스 테이블을 Pickle 파일로 추출하는 스크립트
...
output_path = f"data/{TABLE_NAME}_{date_str}.pkl"
...
# 5️⃣ Pickle 파일로 저장
print(f"💾 Pickle 파일로 저장 중... ({output_path})")

df.to_pickle(output_path)

print(f"🎉 Pickle 파일 저장 완료: {output_path}")
